...
**Bayesian Explorer**: An interactive Shiny application I built to help students and practitioners develop intuition for Bayesian concepts. It visualizes prior-likelihood-posterior relationships and lets you explore how different priors affect inference in real-time. [Try it here →](https://ckisxn-godwill-zulu.shinyapps.io/bayesian-explorer/)
